...
def main() -> None:
    ...
    parser.add_argument(
        "--hide_output", action="store_false",
    ...
    if not args.view:
        exp_02_09_model_v01.simulate(exp, args.save, args.hide_output)
    else:
        try:
            ...
            exp_02_09_model_v01.simulate(exp, True, False)
            play_arm_path.play_traj(exp)
